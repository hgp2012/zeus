...
/*	Tuple<JobDescriptor,JobStatus> getActionDescriptor(String jobId);*/
	 ...
	 * @throws ZeusException 
	 */
	Tuple<JobDescriptorOld, JobStatus> updateVersion(String user, String gmtModified, String id) throws ZeusException;
	 ...
	 * @throws ZeusException 
	 */
	List<JobPersistenceOld> getJobDescriptors2(Collection<String> jobIds);

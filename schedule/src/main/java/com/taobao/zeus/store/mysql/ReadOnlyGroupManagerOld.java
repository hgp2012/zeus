...
//	}
	...
	private class ReadOnlyGroupManagerAssemblyOld implements GroupManagerOld{
		...
		@Override
		public Tuple<JobDescriptorOld, JobStatus> updateVersion(String user, String gmtModified, String id)
				throws ZeusException {
			// TODO Auto-generated method stub
			return null;
		}
		@Override
		public List<JobPersistenceOld> getJobDescriptors2(Collection<String> jobIds) {
			// TODO Auto-generated method stub
			System.out.println("=ReadOnlyGroupManagerOld==========getJobDescriptors2============");
			return null;
		}
	}

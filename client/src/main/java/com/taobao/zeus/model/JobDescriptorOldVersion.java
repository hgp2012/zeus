 ...
 *
 */
public class JobDescriptorOldVersion implements Serializable {
	...
	public JobDescriptorOldVersion getCopy() {
		JobDescriptorOldVersion jobDescriptor = new JobDescriptorOldVersion();
		...
		jobDescriptor.setJobId(this.jobId);
